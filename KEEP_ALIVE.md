...
## How it Works
The automation is defined in [`.github/workflows/keep_alive.yml`](file:///Users/chanakyavasantha/ic3/AIP-Guide/AIPassport/.github/workflows/keep_alive.yml). It is scheduled to run every 6 hours and manually via the **Actions** tab.
