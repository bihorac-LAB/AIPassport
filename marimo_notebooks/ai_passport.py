...
def _(json):
  ...
  },
  {
    ...
    "module": "3",
    "module_name": "Data",
    "title": "Cardiovascular Risk Data Preprocessing Lab",
    "objectives": [
      "Inspect noisy clinical feature data.",
      "Apply winsorization to cap extreme measurements.",
      "Choose an imputation method for missing values.",
      "Scale clinical features and inspect distribution changes."
    ],
    "sections": [
      {
        "title": "Overview",
      ...
      },
      {
        ...
        "body": [
          "Use boxplots to inspect remaining skew and outliers.",
      ...
      {
        "title": "Case Study and Instructions",
        "body": [
          "Frame the clinical data-quality problem."
        ],
        "prompts": []
      },
      {
        ...
        "body": [
          "Control winsorization, imputation, and scaling."
        ],
        "prompts": []
      },
      {
        ...
        "body": [
          "Inspect cleaned rows after preprocessing."
        ],
        "prompts": []
      }
    ],
    "source": "notebooks/clinical/3.5_clinical.py"
  },
  {
    "id": "3.6",
    "module": "3",
  ...
  },
  {
    ...
    "source": "notebooks/clinical/4.2_clinical.py"
  },
  {
    "id": "4.3",
    "module": "4",
  ...
  },
  {
    ...
    "module": "4",
    "module_name": "Machine Learning",
    "title": "Healthcare AI Fairness Sandbox",
    "objectives": [],
    "sections": [
      {
        "title": "Activity 1: Data Preview and Fairness Metrics",
        "body": [
      ...
      {
        "title": "Activity 2: Global Explainability with SHAP",
        "body": [
      ...
      {
        "title": "Activity 3: Local Explainability with LIME",
        "body": [
      ...
      {
        "title": "Activity 4: The 'What-If' Simulation",
        "body": [
    ...
    "source": "notebooks/clinical/4.7_clinical.py"
  },
  {
    "id": "5.1",
    "module": "5",
  ...
  },
  {
    ...
    "module": "5",
    "module_name": "Images",
    "title": "Biomedical Toolkit",
    "objectives": [],
    "sections": [
      {
        "title": "Overview",
        "body": [
          "⚠️ **Confidentiality:** Do not upload patient-identifiable images."
        ],
        "prompts": []
      },
      {
        ...
        "body": [
          "Sample file not found. Generating synthetic phantom..."
        ],
        "prompts": []
      },
      {
        "title": "Action Map (What changed?)",
        "body": [
          "The bright areas indicate where the Closing operation filled in dark holes.",
          "Please upload an ultrasound scan to begin."
        ],
        "prompts": []
      }
    ],
    "source": "notebooks/clinical/5.3_clinical.py"
  },
  {
    "id": "5.4",
    "module": "5",
    "module_name": "Images",
    "title": "Clinical Computer Vision Applications",
    "objectives": [],
    "sections": [
      {
        "title": "Overview",
        "body": [
          "The original embedded HTML export is not present in this repository. This page now provides a stable in-app review activity instead of failing at runtime."
        ],
        "prompts": []
      },
      {
        "title": "Clinical Computer Vision Application Review",
        "body": [
          ...
          "Good answers should mention image quality, subgroup performance, external validation, clinical workflow fit, and human review."
        ],
        "prompts": [
          "What clinical feature should the model learn?",
          "What patient-safety risk could appear if the model fails?",
          "What validation evidence would be needed before deployment?"
        ]
      }
    ],
    "source": "notebooks/clinical/5.4_clinical.py"
  },
  {
    "id": "5.5",
    "module": "5",
  ...
  },
  {
    "id": "7.1",
    "module": "7",
    "module_name": "Impact Project",
    "title": "7.1 Designing Biomedical AI Experiments",
    "objectives": [],
    "sections": [
      {
        "title": "Overview",
        "body": [
          ...
          "## psychology: Try it: Describe your Biomedical AI Experiment Idea",
    ...
    "source": "notebooks/clinical/7.1_clinical.py"
  },
  {
    "id": "7.2",
    "module": "7",
    "module_name": "Impact Project",
    "title": "7.2 Writing Successful Biomedical AI Proposals",
    "objectives": [],
    "sections": [
      {
        "title": "Overview",
        "body": [
          ...
          "## psychology: Try it: Generate an NIH-Style Project Summary",
          "**Note:** The following activity uses a generative AI model to provide suggestions and feedback. This is an educational tool, not a peer review system."
        ],
        "prompts": [
    ...
    "source": "notebooks/clinical/7.2_clinical.py"
  },
  {
    "id": "7.3",
    "module": "7",
    "module_name": "Impact Project",
    "title": "7.3 Effective Scientific Communication",
    "objectives": [],
    "sections": [
      {
        "title": "Overview",
        "body": [
          "In this activity, you will provide an abstract (or full text) from a research article, and will be presented with an elevator-pitch version designed for broad audiences.",
          "## psychology: Try it: Generate an Elevator Pitch",
          "**Note:** The following activity uses a generative AI model to provide suggestions and feedback. This is an educational tool, not a peer review system."
        ],
        "prompts": [
    ...
    "source": "notebooks/clinical/7.3_clinical.py"
  },
  {
    "id": "7.4",
    "module": "7",
    "module_name": "Impact Project",
    "title": "7.4 Bridging Traditional Research with AI Innovation",
    "objectives": [],
    "sections": [
      {
        "title": "Overview",
        "body": [
          ...
          "## psychology: Try it: AI Solutions for Biomedical Challenges",
          "**Note:** The following activity uses a generative AI model to provide suggestions and feedback. This is an educational tool, not a peer review system."
        ],
        "prompts": [
    ...
    "source": "notebooks/clinical/7.4_clinical.py"
  },
  {
    "id": "7.5",
    "module": "7",
    "module_name": "Impact Project",
    "title": "7.5 Peer Review and Feedback",
    "objectives": [],
    "sections": [
      {
        "title": "Overview",
        "body": [
          ...
          "## psychology: Try it: Critique Generator for Biomedical AI Research Ideas",
          "**Note:** The following activity uses a generative AI model to provide suggestions and feedback. This is an educational tool, not a peer review system."
        ],
        "prompts": [
  ...
  },
  {
    ...
    "module": "7",
    "module_name": "Impact Project",
    "title": "7.6 Robust Biomedical AI Research Design",
    "objectives": [],
    "sections": [
      {
        "title": "Overview",
        "body": [
          ...
          "## psychology: Try it: Datasheet and Model Card Generator",
          "**Note:** The following activity uses a generative AI model to provide suggestions and feedback. This is an educational tool, not a peer review system."
        ],
        "prompts": [
    ...
    "source": "notebooks/clinical/7.6_clinical.py"
  },
  {
    "id": "7.7",
    "module": "7",
    "module_name": "Impact Project",
    "title": "7.7 Responsible Biomedical AI Research",
    "objectives": [],
    "sections": [
      {
        "title": "Overview",
        "body": [
          ...
          "## psychology: Try it: Navigating Research Misconduct",
          "**Note:** The following activity uses a generative AI model to provide suggestions and feedback. This is an educational tool, not a peer review system."
        ],
        "prompts": [
    ...
    "source": "notebooks/clinical/7.7_clinical.py"
  }
]""")
    module_names = {
        "1": "Fundamentals",
...
def _(mo):
    mo.Html(
        ...
        <div class="passport-banner">
          ...
          <p>36 consolidated lessons, ported to reactive marimo apps.</p>
        </div>
        """
    )
    return
