...
app = marimo.App(width="medium", app_title="7.3 · AI Passport")
...
def _(lesson, mo):
    mo.Html(
        ...
        <div class="aip-hero">
          <div class="aip-kicker">AI Passport · Module 7: Impact Project</div>
          <h1>7.3 · 7.3 Effective Scientific Communication</h1>
