...
OUTCOME_FRAMING = (
    "This is a supervised binary classification problem in its plainest form: a fixed-width numeric feature "
    "vector, one binary label, and a modest number of observations. Everything you build here transfers "
    "directly to an assay readout or an expression matrix — the pipeline does not care what the columns mean."
)
