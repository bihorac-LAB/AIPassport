...
st.title("7.3 Effective Scientific Communication")
...
st.markdown("## :material/psychology: Try it: Generate an Elevator Pitch")
st.caption(
...
gemini_system_instruction_filepath = "assets/llm/7.3_gemini_system_instruction.txt"
